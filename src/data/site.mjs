...
export const sectionPages = {
  products: {
    ...
    footer: "HARNESS_ATLAS / PRODUCTS",
    cards: [
      ["CODING", "Coding Agents", "Codex、Claude Code、OpenCode 等研发工作流产品。"],
      ["SDK", "Frameworks", "Agent 框架、开发 SDK 与运行时抽象。"],
      ["MATRIX", "Comparison", "横向对比上下文、工具、权限、状态和集成能力。"],
      ["FLOW", "Interaction", "IDE、终端、桌面、Web Cloud 等交互表面。"],
    ],
  },
  standards: {
    ...
    footer: "HARNESS_ATLAS / STANDARDS",
    cards: [
  ...
  patterns: {
    ...
    footer: "HARNESS_ATLAS / PATTERNS",
    cards: [
      ["CTX", "Context", "上下文选择、压缩、刷新和边界控制。"],
      ["TOOLS", "Tools", "工具调用、权限控制、错误恢复和日志。"],
      ["EXEC", "Execution", "计划执行循环、任务状态和交付闭环。"],
      ["MULTI", "Multi-agent", "多 Agent 协作、委派、汇总和冲突控制。"],
      ["EVAL", "Evaluation", "测试、Benchmark、人工审查和指标体系。"],
      ["GOV", "Governance", "安全、权限、审计、成本和合规治理。"],
    ],
  },
  research: {
  ...
  timeline: {
    ...
    footer: "HARNESS_ATLAS / TIMELINE",
    cards: [
      ["PRODUCT", "Coding Agent 更新", "影响上下文、工具、权限、执行和评估方式的重要功能。"],
  ...
  references: {
    ...
    footer: "HARNESS_ATLAS / REFERENCES",
    cards: [
      ["DOCS", "Official Docs", "Agent 产品、框架、协议和平台官方文档。"],
      ["PAPERS", "Papers", "论文、预印本和技术报告索引。"],
      ["BLOGS", "Blogs", "技术博客、工程文章和产品文章。"],
      ["LOGS", "Changelogs", "产品更新日志、官方博客和文档更新页。"],
    ],
  },
};
