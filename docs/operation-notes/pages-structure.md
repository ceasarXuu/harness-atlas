...
- The homepage hero can use a stacked layout where the formula copy comes first and the runtime map follows as a full-width block; verify the map sits below the copy and keeps zero horizontal overflow.
